...
#' References:                                                                                                                                    '#
#' Butler, D. G., Cullis, B.R., A. R. Gilmour, Gogel, B.G. and Thompson, R. 2017. ASReml-R Reference Manual Version 4. VSN International Ltd,     '#
...
#'                                                                                                                                                '#
#' ASReml-R requires a very SPECIFIC format to read a known relatedness or inverse relatedness matrix from an external source. This symmetric     '#
#' inverse matrix (or just a symmetric matrix) can be included as (Butler at al. 2017); a) a sparse inverse covariance matrix held in three       '#
#' column co-ordinate form in row major order. This triplet matrix must have class ginv attribute INVERSE set to TRUE. b) have  a sparse          '#
#' relatedness matrix held in three column coordinate form in row major order. If the attribute INVERSE is not set then FALSE is assumed; a       '#
#' attribute must be set. c) a matrix (or Matrix object) with a dimnames attribute giving the levels of the model term being defined. This may be '#
#' a relatedness matrix or its inverse; if an inverse, it must have an attribute INVERSE set to TRUE.                                             '#
#' In all cases the matrix object must have an attribute rowNames, a character vector that uniquely identifies each row of the relatedness        '#  
#' matrix.                                                                                                                                        '#
#'                                                                                                                                                '#
#' Arguments                                                                                                                                      '#
#'                                                                                                                                                '#
...
#' @param rowNames                                                                                                                                '#
#'                                                                                                                                                '#
#' A character vector set as the "rowNames" attribute of the input sparse matrix. The default is the dimnames(Gsinv)[[1] attribute of the leading '#
#' dimension of Gsinv.                                                                                                                            '#
#'                                                                                                                                                '#
#' @param colnames                                                                                                                                '#
#'                                                                                                                                                '#
